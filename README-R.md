...
- [Авторы проекта](#project-creators)
  
[**Первый уровень:**](#level-1)
- [Введение (первый уровень)](#introduction-first-level)
- [Реализация алгоритма](#implementation-of-algorithm)
- [Структуры данных для ускорения](#data-structure-for-acceleration)
  
[**Второй уровень:**](#level-2)
- [Введение (второй уровень)](#introduction-second-level)
- [Графические особенности](#graphic-features)
- [Реализация графики](#implementation-of-graphics)

## Установка и сборка <a id="installation-and-build"></a>
...
## Авторы проекта <a id="project-creators"></a>
...
## Введение (первый уровень) <a id="introduction-first-level"></a>
...
## Реализация алгоритма <a id="implementation-of-algorithm"></a>
...
## Структуры данных для ускорения <a id="data-structure-for-acceleration"></a>
...
## Введение (второй уровень) <a id="introduction-second-level"></a>
...
## Реализация графики <a id="implementation-of-graphics"></a>
